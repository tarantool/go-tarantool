...
box.once("init", function()
    ...
    box.schema.user.grant('test', 'create,execute', 'universe')
    box.schema.user.grant('test', 'create,read,write', 'space', '_queue')
    box.schema.user.grant('test', 'read,write', 'space', '_space_sequence')
    box.schema.user.grant('test', 'read,write', 'space', '_schema')
    box.schema.user.grant('test', 'create,read,write', 'space', '_space')
