...
func TestBenchmarkAsync(t *testing.T) {
	...
	for cn := 1; cn <= connections; cn *= 2 {
		for cc := 1; cc <= 1; cc *= 2 { // for cc := 1; cc <= 512; cc *=2 {
			...
			fmt.Println("concurrency:", cc)                       // nolint
			fmt.Println("connections:", cn)                       // nolint
			fmt.Printf("duration   : %.2f\n", duration.Seconds()) // nolint
	...
	fmt.Println("max connections:", maxConnections) // nolint
	fmt.Println("max concurrency:", maxConcurrency) // nolint
	fmt.Printf("max requests/s : %.2f", maxRps) // nolint
}
